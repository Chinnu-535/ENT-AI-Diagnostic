...
train_images, train_labels = load_images_from_folder("E:/3rd_Year_sem1/Projects/ML_Database/Datos/Training-validation")
test_images, test_labels = load_images_from_folder("E:/3rd_Year_sem1/Projects/ML_Database/Datos/Testing")
